...
class CRNN(nn.Module):
    ...
    def set_masks(self, masks):
        self.rnn[0].embedding.set_mask(masks[11])
        self.rnn[1].embedding.set_mask(masks[16])
...
class Bilstm(nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, BN=True):
        ...
        self.embedding = MaskedLinear(in_features=hidden_channels * 2, out_features=out_channels)
